      ...
      <div className="container mx-auto px-4">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="bg-blue-400 text-white p-3 rounded-lg hover:bg-blue-500 transition duration-300"
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <section className="mt-16 max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="font-semibold mb-3">Do you work on weekends?</h3>
              <p className="text-gray-600">While I prefer to maintain work-life balance, I'm flexible for urgent projects.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="font-semibold mb-3">What's your hourly rate?</h3>
              <p className="text-gray-600">My rates vary depending on the project scope. Let's discuss your specific needs.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="font-semibold mb-3">Do you offer ongoing support?</h3>
              <p className="text-gray-600">Yes, I provide maintenance and support packages for projects I've worked on.</p>
            </div>
          </div>
        </section>
      </div>
