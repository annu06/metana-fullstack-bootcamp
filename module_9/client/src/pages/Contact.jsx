...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await usersService.submitContactForm(formData);
      setSuccess(true);
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">hello@blogspace.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                <div className="w-12 h-12 bg-success-100 rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
